...
class postNegWords {
	public static String[] posWords = { "ABIDE", "ABILITY", "ABLE", "ABOUND", "ABSOLVE", "ABSORBENT", "ABSORPTION",
			"ABUNDANCE", "ABUNDANT", "ACCEDE", "ACCENTUATE", "ACCEPT", "ACCEPTABLE", "ACCEPTANCE", "ACCESSIBLE",
			"ACCESSION", "ACCLAIM", "ACCLAMATION", "ACCOLADE", "ACCOMMODATE", "ACCOMMODATION", "ACCOMPANIMENT",
			"ACCOMPLISH", "ACCOMPLISHMENT", "ACCORD#2", "ACCORD#3", "ACCORD#5", "ACCORDANCE", "ACCOUNTABLE", "ACCRUE",
			"ACCURACY", "ACCURATE", "ACCURATENESS", "ACHIEVE", "ACHIEVEMENT", "ACKNOWLEDGEMENT", "ACQUAINT",
			"ACQUAINTANCE", "ACQUIT", "ACQUITTAL", "ACTUAL#1", "ACTUAL#2", "ACTUALITY", "ADAMANT", "ADAPTABILITY",
			"ADAPTABLE", "ADAPTATION", "ADAPTIVE", "ADEPT", "ADEPTNESS", "ADEQUATE", "ADHERENCE", "ADHERENT",
			"ADHESION", "ADHESIVE", "ADJUNCT", "ADJUST#2", "ADJUSTABLE", "ADJUSTMENT", "ADMIRABLE", "ADMIRATION",
			"ADMIRE", "ADMIRER", "ADMIT#1", "ADMIT#2", "ADMIT#3", "ADMITTANCE", "ADORABLE", "ADORE", "ADORN",
			"ADORNMENT", "ADROIT", "ADROITLY", "ADULATION", "ADULT#2", "ADVANCE#1", "ADVANCE#2", "ADVANCE#3",
			"ADVANCEMENT", "ADVANTAGE", "ADVANTAGEOUS", "ADVENT", "ADVENTURESOME", "ADVENTUROUS", "ADVISABLE",
			"ADVOCACY", "AFFABILITY", "AFFABLE", "AFFECTION", "AFFECTIONATE", "AFFILIATE", "AFFILIATION", "AFFINITY",
			"AFFIRM", "AFFIRMATION", "AFFIRMATIVE", "AFFIX", "AFFLUENCE", "AFFLUENT", "AFLOAT", "AGGREGATE",
	...
	public static String[] negWords = { "ABANDON", "ABANDONMENT", "ABATE", "ABDICATE", "ABHOR", "ABJECT", "ABNORMAL",
			"ABOLISH", "ABOMINABLE", "ABRASIVE", "ABRUPT", "ABSCOND", "ABSENCE", "ABSENT#1", "ABSENT-MINDED",
			"ABSENTEE", "ABSURD", "ABSURDITY", "ABUSE#1", "ABUSE#2", "ABYSS", "ACCIDENT", "ACCOST", "ACCURSED",
			"ACCUSATION", "ACCUSE#1", "ACCUSE#2", "ACHE", "ACRIMONIOUS", "ACRIMONY", "ADDICT", "ADDICTION", "ADMONISH",
			"ADMONITION", "ADULTERATE", "ADULTERATION", "ADULTERY", "ADVERSARY", "ADVERSE", "ADVERSITY", "AFFECTATION",
			"AFFLICT", "AFFLICTION", "AFRAID#2", "AGAINST", "AGGRAVATE", "AGGRAVATION", "AGGRESSION", "AGGRESSIVE",
